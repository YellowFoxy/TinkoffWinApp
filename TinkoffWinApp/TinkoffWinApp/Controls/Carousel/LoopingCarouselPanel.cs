...
{
    public class LoopingCarouselPanel : Panel
    {
        ...
        private LoopingCarousel carouselControl;

        public LoopingCarouselPanel()
        {
        ...
        public LoopingCarousel Carousel
        {
            get
            {
                ...
                carouselControl = this.FindAscendant<LoopingCarousel>();
