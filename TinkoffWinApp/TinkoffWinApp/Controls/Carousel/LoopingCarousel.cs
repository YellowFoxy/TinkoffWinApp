...
{
    public class LoopingCarousel : ItemsControl
    {
        /// <summary>
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register("SelectedItem", typeof(object), typeof(LoopingCarousel), new PropertyMetadata(null, OnLoopingCarouselPropertyChanged));
        ...
        public static readonly DependencyProperty SelectedIndexProperty =
            DependencyProperty.Register("SelectedIndex", typeof(int), typeof(LoopingCarousel), new PropertyMetadata(-1, OnLoopingCarouselPropertyChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty TransitionDurationProperty = DependencyProperty.Register("TransitionDuration", typeof(int), typeof(LoopingCarousel), new PropertyMetadata(200));
        ...
        /// </summary>
        public static readonly DependencyProperty ItemDepthProperty = DependencyProperty.Register("ItemDepth", typeof(int), typeof(LoopingCarousel), new PropertyMetadata(0, OnLoopingCarouselPropertyChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty EasingFunctionProperty = DependencyProperty.Register("EasingFunction", typeof(EasingFunctionBase), typeof(LoopingCarousel), new PropertyMetadata(null));
        ...
        /// </summary>
        public static readonly DependencyProperty ItemMarginProperty = DependencyProperty.Register("ItemMargin", typeof(int), typeof(LoopingCarousel), new PropertyMetadata(0, OnLoopingCarouselPropertyChanged));
        ...
        public static readonly DependencyProperty InvertPositiveProperty =
            DependencyProperty.Register("InvertPositive", typeof(bool), typeof(LoopingCarousel), new PropertyMetadata(true, OnLoopingCarouselPropertyChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty ItemRotationXProperty = DependencyProperty.Register("ItemRotationX", typeof(double), typeof(LoopingCarousel), new PropertyMetadata(0d, OnLoopingCarouselPropertyChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty ItemRotationYProperty = DependencyProperty.Register("ItemRotationY", typeof(double), typeof(LoopingCarousel), new PropertyMetadata(0d, OnLoopingCarouselPropertyChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty ItemRotationZProperty = DependencyProperty.Register("ItemRotationZ", typeof(double), typeof(LoopingCarousel), new PropertyMetadata(0d, OnLoopingCarouselPropertyChanged));

        /// <summary>
        /// Gets or sets the LoopingCarousel orientation. Horizontal or Vertical
        /// </summary>
        ...
        /// </summary>
        public static readonly DependencyProperty OrientationProperty = DependencyProperty.Register("Orientation", typeof(Orientation), typeof(LoopingCarousel), new PropertyMetadata(Orientation.Horizontal, OnLoopingCarouselPropertyChanged));

        /// <summary>
        /// Each time a property change, we have to reposition
        /// </summary>
        private static void OnLoopingCarouselPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            LoopingCarousel carouselControl = (LoopingCarousel)d;
            ...
            if (e.Property == SelectedIndexProperty)
            {
                ...
                if (oldValue != null)
                {
                    var item = (LoopingCarouselItem)carouselControl.ContainerFromIndex((int)e.OldValue);
                    if (item != null)
                    {
                ...
                if (newValue != null)
                {
                    var item = (LoopingCarouselItem)carouselControl.ContainerFromIndex((int)e.NewValue);
                    if (item != null)
                    {
        ...
        private void FocusContainerFromIndex(int index)
        {
            ...
            if (oldElem != null && oldElem is LoopingCarouselItem)
            {
        ...
        internal LoopingCarouselPanel GetItemsPanel()
        {
            return this.FindDescendant<LoopingCarouselPanel>();
        }

        /// <summary>
        /// Returns the container used for each item
        /// </summary>
        /// <returns>Returns always a LoopingCarouselItem</returns>
        protected override DependencyObject GetContainerForItemOverride()
        {
            return new LoopingCarouselItem();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="LoopingCarousel"/> class.
        /// </summary>
        public LoopingCarousel()
        {
            // Set style
            DefaultStyleKey = typeof(LoopingCarousel);
            SetValue(AutomationProperties.NameProperty, "LoopingCarousel");
            ...
            PointerReleased += LoopingCarouselControl_PointerReleased;
            ...
            {
                var carouselControl = (LoopingCarousel)d;
        ...
        private void LoopingCarouselControl_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
        ...
        {
            return item is LoopingCarouselItem;
        }
        ...
        protected override void ClearContainerForItemOverride(DependencyObject element, object item)
        {
            ...
            var carouselItem = (LoopingCarouselItem)element;
            carouselItem.Selected -= OnLoopingCarouselItemSelected;
        }
        ...
        private void OnLoopingCarouselItemSelected(object sender, EventArgs e)
        {
